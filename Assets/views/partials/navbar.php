<header class="header">
    <nav class="navbar d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4">
        ...
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
            <li><a href="#" class="nav-link px-3 activeLink">Home</a></li>
            <li><a href="#" class="nav-link px-3 navLinks">Features</a></li>
            <li><a href="#" class="nav-link px-3 navLinks">Pricing</a></li>
            <li><a href="#" class="nav-link px-3 navLinks">FAQs</a></li>
            <li><a href="#" class="nav-link px-3 navLinks">About</a></li>
        </ul>
